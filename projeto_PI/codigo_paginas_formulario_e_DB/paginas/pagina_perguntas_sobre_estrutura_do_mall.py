...
def perguntas_estrutura():
    ...
    st.session_state.p1_pe = st.selectbox(f" {st.session_state.nome} como você avalia a infraestrutura geral do shopping?",escala_satisfacao, index=escala_satisfacao.index(st.session_state.p1_pe))
